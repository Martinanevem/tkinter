...
jelenlegi_pont = database.child("Teglatoro").get().val()

ranglista_szoveg = Label(ablak1, text="Téglatörő ranglista", font=('Helvetica bold', 16)).grid(padx=120,row=5, column=0, columnspan=2)
row = 7
